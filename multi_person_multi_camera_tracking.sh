...
#        sources+="souphttpsrc location=http://127.0.0.1:8888/office-test name=source_$n ! decodebin ! \
...
function create_sources() {
    for ((n = 0; n < $num_of_src; n++)); do
        sources+="rtspsrc location=rtsp://127.0.0.1:8554/office-test$n ! decodebin ! \
